...
router.get('/buscar-roomid/:id_room',room.buscaridroom)
router.get('/buscar-roomautor/:id_room',room.buscarautor)
router.get('/buscar-roomrondas/:id_room',room.buscarrondas)
